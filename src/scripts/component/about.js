class AboutSection extends HTMLElement {
  ...
  render() {
    this.innerHTML = `
    <section>
      <article id="about-us" class="about--section">
        <h1 class="about__section--header">About Us</h1>
        ...
        <ul class="about__section--social">
          <li>
            <a href="https://www.linkedin.com/in/dedybastiant/" target="_blank" class="about__section--linkedin">
          ...
          <li>
          <a href="https://github.com/dedybastiant" target="_blank" class="about__section--github">
      ...
      <article class="download--section">
        <h1 class="download__section--header">Download</h1>
        <button class="download__section--button">Downlaod iOS</button>
        <button class="download__section--button">Download Android</button>
      </article>
    </section>
    `;
  }
